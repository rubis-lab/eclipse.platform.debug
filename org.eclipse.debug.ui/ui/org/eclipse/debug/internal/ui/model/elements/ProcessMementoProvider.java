...
/**
 * Memento provider for the process element.
 * 
 * @since 3.9
 */
public class ProcessMementoProvider extends DebugElementMementoProvider {
	 ...
	 */
	protected String getElementName(Object element, IPresentationContext context)
			throws CoreException 
	{
		if (element instanceof IProcess) {
			return ((IProcess)element).getLabel();
		}
		return null;
	}
